...
```{r Inst_Growth_by_Level_over_Time, fig.cap="Growth of Postsecondary Institutions by Level", warning=FALSE}
Inst_Level_table %>% 
...
```{r Inst_Growth_by_Control_over_Time, fig.cap="Institutional Growth by Control Over Time", warning=FALSE}
Inst_Control_table %>% 
